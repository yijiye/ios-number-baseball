...
<img src = "https://user-images.githubusercontent.com/70146658/208584198-60fc9c84-51c3-45af-8dc3-d8eb5fb9c1a1.png" width = "500" height = "1000">
...
|사용자 승리|컴퓨터 승리|
|---|---|
|<img width="320" alt="스크린샷 2022-12-23 오후 4 32 06" src="https://user-images.githubusercontent.com/114971172/209277493-07774860-8958-4e07-96a2-9cd5d24a5584.png">|<img width="320" alt="스크린샷 2022-12-23 오후 4 32 06" src="https://user-images.githubusercontent.com/70146658/209292504-8c9cae30-706e-45b3-8acb-691ca249756f.png">|
|[사용자승리]</br>- 코드를 실행하면 게임 메뉴가 출력</br>- 원하는 기능인 1을 입력하면 안내 문구 출력 후 입력칸 출력</br>- 임의의 수 3개 입력받기</br>- 입력받은 숫자가 스트라이크인지 볼인지 판별하여 결과 출력</br>- 남은 기회가 차감되어 출력</br>- 3 스트라이크 달성 후 사용자 승리! 출력</br>- 다시 게임 시작|[컴퓨터승리]</br>- 코드를 실행하면 게임 메뉴가 출력</br>- 원하는 기능인 1을 입력하면 안내 문구 출력 후 입력칸 출력</br>- 임의의 수 3개 입력받기</br>- 입력받은 숫자가 스트라이크인지 볼인지 판별하여 결과 출력</br>- 남은 기회가 차감되어 출력</br> - 남은 기회가 0이고 사용자가 3 스트라이크를 완성하지 못하면 컴퓨터 승리...! 출력</br>- 다시 게임 시작|
